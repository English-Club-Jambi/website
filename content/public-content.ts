...
export const publicContentManifest = {
  global: page("global", "Header and footer", {
    ...
    footerPrivacy: text("footer-privacy", "Privacy link", "Privacy", 28),
    footerInstitution: text(
      "footer-institution",
      "Institutional relationship label",
      "Formed through Perpustakaan Universitas Jambi",
      100,
    ),
  ...
  practice: page("practice", "Practice", {
    ...
    deliveryTitle: text(
      "delivery-title",
      "Result email section title",
      "Keep a copy of this result.",
      80,
    ),
    deliverySupport: text(
      "delivery-support",
      "Result email section support",
      "Email the result summary, section notes, a completion certificate, and a private link to the full review.",
      200,
    ),
    certificateNameLabel: text(
      "certificate-name-label",
      "Certificate name field label",
      "Name on certificate",
      60,
    ),
    certificateNameHelp: text(
      "certificate-name-help",
      "Certificate name field help",
      "Use the spelling you want printed in the PDF. English Club does not verify identity for this completion record.",
      180,
    ),
    deliveryEmailLabel: text(
      "delivery-email-label",
      "Result delivery email field label",
      "Email address",
      50,
    ),
    deliveryEmailHelp: text(
      "delivery-email-help",
      "Result delivery email field help",
      "We will use this address only to deliver this practice record.",
      140,
    ),
    certificateDesignLabel: text(
      "certificate-design-label",
      "Certificate design label",
      "Certificate design",
      50,
    ),
    certificateDefaultReady: text(
      "certificate-default-ready",
      "Default certificate summary",
      "Mendalo Record is ready.",
      80,
    ),
    certificateDefaultDescription: text(
      "certificate-default-description",
      "Default certificate description",
      "A formal cobalt record with a quiet batik line.",
      120,
    ),
    certificateChoose: text(
      "certificate-choose",
      "Open certificate chooser action",
      "Choose another design",
      60,
    ),
    certificateChooserTitle: text(
      "certificate-chooser-title",
      "Certificate chooser title",
      "Choose a certificate design",
      70,
    ),
    certificateChooserSupport: text(
      "certificate-chooser-support",
      "Certificate chooser support",
      "The wording and result stay the same. Only the layout changes.",
      140,
    ),
    certificateChooserClose: text(
      "certificate-chooser-close",
      "Close certificate chooser action",
      "Close certificate chooser",
      50,
    ),
    certificateUseDesign: text(
      "certificate-use-design",
      "Apply certificate design action",
      "Use this design",
      50,
    ),
    certificateKeepDesign: text(
      "certificate-keep-design",
      "Cancel certificate design action",
      "Keep current design",
      50,
    ),
    deliveryConsent: text(
      "delivery-consent",
      "Result delivery consent",
      "I agree that English Club may use this name and email address to prepare and send this practice record.",
      220,
    ),
    deliveryRetention: text(
      "delivery-retention",
      "Result delivery retention note",
      "The private review link expires after 30 days. English Club does not store the name or email address in its delivery log.",
      220,
    ),
    deliveryAction: text(
      "delivery-action",
      "Send result email action",
      "Email my result",
      50,
    ),
    deliveryPending: text(
      "delivery-pending",
      "Preparing result email status",
      "Preparing your certificate and email.",
      100,
    ),
    deliverySuccessTitle: text(
      "delivery-success-title",
      "Result email accepted title",
      "Your email is on its way.",
      80,
    ),
    deliverySuccessBody: text(
      "delivery-success-body",
      "Result email accepted support",
      "Brevo accepted the message for {email}. It may take a few minutes to arrive.",
      140,
    ),
    deliverySendAnother: text(
      "delivery-send-another",
      "Send another result copy action",
      "Send another copy",
      50,
    ),
    deliveryGenericError: text(
      "delivery-generic-error",
      "Result email generic error",
      "We could not prepare this email. Your result is still here, so try again in a moment.",
      180,
    ),
    certificateNameError: text(
      "certificate-name-error",
      "Certificate name rendering error",
      "That name cannot fit this certificate yet. Shorten it or use Latin letters and common diacritics.",
      180,
    ),
    sharedReviewUnavailableTitle: text(
      "shared-review-unavailable-title",
      "Private review unavailable title",
      "The private review is unavailable.",
      100,
    ),
    sharedReviewUnavailableBody: text(
      "shared-review-unavailable-body",
      "Private review unavailable support",
      "The link may have expired or been replaced. Return to Assessment Lab to start or review a practice from this browser.",
      220,
    ),
  ...
  about: page("about", "About", {
    ...
    identityEyebrow: text(
      "identity-eyebrow",
      "Institutional record eyebrow",
      "Institutional record",
      50,
    ),
    identityTitle: text(
      "identity-title",
      "Institutional record title",
      "English Club, in the university record.",
      100,
    ),
    identityOfficialLabel: text(
      "identity-official-label",
      "Official name label",
      "Name in the formation record",
      60,
    ),
    identityOfficialName: text(
    ...
    identityBody: text(
      "identity-body",
      "Institutional relationship statement",
      "UPT Perpustakaan Universitas Jambi formed the club on 16 May 2024. The published opening record states that Universitas Jambi's Vice Rector IV ratified its formation.",
      320,
    ),
    identityClarifier: text(
      "identity-clarifier",
      "Short name clarification",
      "This site uses “English Club” as its short public name. The institutional wording above follows the library's published formation record.",
      280,
    ),
    identityLogoAlt: text(
      "identity-logo-alt",
      "UNJA emblem alternative text",
      "Universitas Jambi emblem",
      80,
    ),
    identityFormationLink: text(
      "identity-formation-link",
      "Formation record link",
      "Read the formation record",
      60,
    ),
    identityLibraryLink: text(
      "identity-library-link",
      "Library link",
      "Visit Perpustakaan UNJA",
      60,
    ),
    identityUniversityLink: text(
      "identity-university-link",
      "UNJA identity link",
      "Read UNJA's identity page",
      60,
    ),
  ...
  privacy: page("privacy", "Privacy", {
    metadataTitle: text("metadata-title", "Browser title", "Privacy", 70),
    metadataDescription: text(
      "metadata-description",
      "Search and share description",
      "Read how English Club handles contact messages, member profiles, practice records, media, and privacy requests.",
      200,
    ),
    heroEyebrow: text("hero-eyebrow", "Hero eyebrow", "Privacy, in plain terms", 70),
    heroTitleLineOne: text("hero-title-line-one", "Hero title line one", "Your details have", 50),
    heroTitleLineTwo: text("hero-title-line-two", "Hero title line two", "a defined job.", 50),
    heroSupport: text(
      "hero-support",
      "Hero supporting text",
      "This page explains what the site records, who can use it, and how long it stays in the system.",
      200,
    ),
    summaryTitle: text("summary-title", "Summary title", "The short version", 60),
    summaryBody: text(
      "summary-body",
      "Summary body",
      "English Club collects only the information needed to run a requested feature. Contact messages stay private, member profiles require review and publication consent, and practice attempts belong to the signed-in participant.",
      360,
    ),
    operatorLabel: text("operator-label", "Site operator label", "Site operator", 40),
    operatorBody: text(
      "operator-body",
      "Site operator description",
      "Authorized English Club administrators operate this website. The club was formed through UPT Perpustakaan Universitas Jambi, but a message sent through this site enters the club's own private contact desk.",
      360,
    ),
    basisLabel: text(
      "basis-label",
      "Processing basis label",
      "Why processing begins",
      50,
    ),
    basisBody: text(
      "basis-body",
      "Processing basis description",
      "A contact record begins only after explicit consent and a request to the club. A public member profile uses recorded publication consent. A saved Practice attempt begins only after the participant chooses Start.",
      360,
    ),
    contactTitle: text("contact-title", "Contact data title", "When you contact the club", 80),
    contactBody: text(
      "contact-body",
      "Contact data description",
      "The form records your name, email address, selected reason, message, consent time, and operational timestamps. Authorized editors use them only to review and answer the message.",
      360,
    ),
    contactRetentionLabel: text(
      "contact-retention-label",
      "Contact retention label",
      "Maximum retention",
      50,
    ),
    contactRetentionValue: text(
      "contact-retention-value",
      "Contact retention value",
      "180 days after submission",
      60,
    ),
    contactRetentionBody: text(
      "contact-retention-body",
      "Contact retention detail",
      "Messages are removed automatically after that point. An authorized administrator can erase one earlier when a verified privacy request is received.",
      260,
    ),
    memberTitle: text("member-title", "Member data title", "When a profile appears", 80),
    memberBody: text(
      "member-body",
      "Member data description",
      "A member record and a portrait have separate consent checks. Only reviewed profiles marked for publication appear in the directory. The club can correct, unpublish, or remove a profile after verifying the request.",
      360,
    ),
    practiceTitle: text("practice-title", "Practice data title", "When you use Practice", 80),
    practiceBody: text(
      "practice-body",
      "Practice data description",
      "Starting a saved practice creates an anonymous sign-in record and stores the delivered questions, responses, timing, and result needed to resume and review that attempt. You can delete an attempt from its result area; this removes its responses and result records.",
      420,
    ),
    practiceDeliveryTitle: text(
      "practice-delivery-title",
      "Practice email delivery privacy title",
      "When you email a Full Practice result",
      90,
    ),
    practiceDeliveryBody: text(
      "practice-delivery-body",
      "Practice email delivery privacy description",
      "English Club sends the name and email address you enter to Brevo only to prepare and deliver that message. Convex keeps keyed digests and delivery metadata for abuse control for no more than 180 days, not the plain name, address, certificate PDF, or review token. The private access link expires after 30 days and can open at most five 30-minute review sessions. Brevo applies its own service retention as the email processor.",
      520,
    ),
    mediaTitle: text("media-title", "Media and maps title", "Media, maps, and local choices", 90),
    mediaBody: text(
      "media-body",
      "Media and maps description",
      "Reviewed public images are served from Cloudflare R2. The About map loads OpenStreetMap only when it approaches the viewport; Google Maps opens only when you choose directions. Your light or dark theme choice stays in this browser.",
      420,
    ),
    providersTitle: text("providers-title", "Service providers title", "Services that process site data", 100),
    providersBody: text(
      "providers-body",
      "Service providers description",
      "Convex provides the database and authentication layer. Cloudflare R2 stores reviewed media. Brevo processes result emails requested by Full Practice participants. OpenStreetMap supplies the interactive campus map. The site does not currently run advertising trackers.",
      360,
    ),
    requestTitle: text("request-title", "Privacy request title", "Ask for access, correction, or deletion", 100),
    requestBody: text(
      "request-body",
      "Privacy request description",
      "Use the contact form with “Ask a question” and begin the message with “Privacy request”. Send it from the same email address where possible so the club can verify the record before changing it.",
      360,
    ),
    requestLink: text("request-link", "Privacy request link", "Start a privacy request", 60),
    institutionalTitle: text(
      "institutional-title",
      "Institutional contact title",
      "Need the university library instead?",
      90,
    ),
    institutionalBody: text(
      "institutional-body",
      "Institutional contact description",
      "Perpustakaan Universitas Jambi publishes its own email, telephone, and social channels. Those institutional channels are separate from English Club's private contact queue.",
      320,
    ),
    lastReviewedLabel: text("last-reviewed-label", "Last reviewed label", "Policy reviewed", 40),
    lastReviewedValue: text("last-reviewed-value", "Last reviewed date", "28 August 2026", 40),
  }),
  ...
  contact: page("contact", "Contact", {
    ...
    nextBody: text(
      ...
      "Your message enters a private review queue. The club aims to review it within five working days; no public profile is created.",
      180,
    ),
    ...
    consentHelp: text(
      ...
      "Data ini hanya digunakan untuk menanggapi pesan Anda dan dihapus paling lambat 180 hari setelah dikirim.",
      140,
    ),
    consentPrivacyLead: text(
      "consent-privacy-lead",
      "Privacy policy introduction",
      "Read the",
      30,
    ),
    consentPrivacyLink: text(
      "consent-privacy-link",
      "Privacy policy link",
      "privacy policy",
      40,
    ),
    consentRetention: text(
      "consent-retention",
      "Contact retention note",
      "The contact record is removed no later than 180 days after submission.",
      120,
    ),
    operationsEyebrow: text(
      "operations-eyebrow",
      "Contact operations eyebrow",
      "A route with an owner",
      50,
    ),
    ...
    operationsBody: text(
      "operations-body",
      "Contact operations body",
      "The form is English Club's working contact channel. Authorized editors separate membership requests, proposals, and questions before following up by email.",
      320,
    ),
    operationsReviewLabel: text(
      "operations-review-label",
      "Review target label",
      "Review target",
      40,
    ),
    operationsReviewValue: text(
      "operations-review-value",
      "Review target value",
      "Within five working days",
      60,
    ),
    operationsRetentionLabel: text(
      "operations-retention-label",
      "Retention label",
      "Maximum retention",
      50,
    ),
    operationsRetentionValue: text(
      "operations-retention-value",
      "Retention value",
      "180 days",
      40,
    ),
    operationsPrivacyLink: text(
      "operations-privacy-link",
      "Privacy link",
      "How the club handles your details",
      80,
    ),
    channelsTitle: text(
      "channels-title",
      "Institutional channels title",
      "Perpustakaan UNJA channels",
      80,
    ),
    channelsBody: text(
      "channels-body",
      "Institutional channels description",
      "These channels are published by Perpustakaan Universitas Jambi. Use them for library matters; English Club enquiries belong in the form above.",
      320,
    ),
