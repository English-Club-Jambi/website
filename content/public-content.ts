...
export const publicContentManifest = {
  ...
  about: page("about", "About", {
    ...
    metadataDescription: text(
      "metadata-description",
      "Search and share description",
      "Meet English Club, learn how its shared practice works, and find the secretariat inside Perpustakaan Universitas Jambi.",
      200,
    ),
    ...
    headquartersTitle: text(
      "headquarters-title",
      "Secretariat section title",
      "Find the club between classes.",
      90,
    ),
    headquartersIntro: text(
      "headquarters-intro",
      "Secretariat introduction",
      "The English Club secretariat is inside Perpustakaan Universitas Jambi at the Mendalo campus.",
      220,
    ),
    headquartersLabel: text(
      "headquarters-label",
      "Secretariat label",
      "Secretariat",
      40,
    ),
    headquartersPlace: text(
      "headquarters-place",
      "Secretariat place name",
      "Perpustakaan Universitas Jambi",
      100,
    ),
    headquartersAddressLabel: text(
    ...
    headquartersAddress: text(
      ...
      "Street address",
      "Unnamed Road, Jl. Jambi - Muara Bulian KM 15, Mendalo Darat, Kec. Jambi Luar Kota, Kabupaten Muaro Jambi, Jambi 36657",
      260,
    ),
    headquartersPlusCodeLabel: text(
      "headquarters-plus-code-label",
      "Plus code label",
      "Plus code",
      40,
    ),
    headquartersPlusCode: text(
      "headquarters-plus-code",
      "Plus code",
      "9GP8+9X Mendalo Darat, Muaro Jambi Regency, Jambi",
      120,
    ),
    headquartersMapLink: text(
      "headquarters-map-link",
      "Google Maps action",
    ...
    headquartersCopyPlusCode: text(
      "headquarters-copy-plus-code",
      "Copy plus code action",
      "Copy plus code",
      50,
    ),
    headquartersAddressCopied: text(
      "headquarters-address-copied",
      "Address copied message",
      "Address copied.",
      60,
    ),
    headquartersPlusCodeCopied: text(
      "headquarters-plus-code-copied",
      "Plus code copied message",
      "Plus code copied.",
      60,
    ),
    headquartersCopyFailed: text(
      "headquarters-copy-failed",
      "Copy failure message",
      "Copy did not work. Select the text instead.",
      100,
    ),
    handoffBody: text(
      "handoff-body",
