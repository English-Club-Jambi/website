...
export const publicContentManifest = {
  ...
  privacy: page("privacy", "Privacy", {
    ...
    providersBody: text(
      ...
      "Convex provides the database and authentication layer. Cloudflare R2 stores reviewed media. OpenStreetMap supplies the interactive campus map. The site does not currently run advertising trackers.",
      360,
    ),
