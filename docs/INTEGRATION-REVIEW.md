...
| Integrated release run | Earlier evidence predated Admin, Assessment, LAN touch, and the repaired Journal archive | Current source passes TypeScript, ESLint, 116 unit tests, 45 Convex tests, 145 browser cases with 23 intentional skips, Convex codegen/type validation, and a 30-entry production build. Dependency audit reports zero vulnerabilities. |
...
- The complete browser run reports 145 passed and 23 intentional viewport-specific skips across desktop, Pixel 7, and 320 px. A second authenticated LAN run adds two passing Admin touch cases. The production build generated 30 App Router entries.
